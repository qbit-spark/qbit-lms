...
@section('content')
    <div id="admin-content">
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    <h2 class="admin-heading">Weekly Report</h2>
                </div>
            ...
            <div class="row">
                <div class="offset-md-3 col-md-6">
                    <form class="yourform" action="{{ route('reports.week_wise_generate') }}" method="post">
                        @csrf
            ...
            @if(!empty($books))
                <div class="row mt-4">
                    <div class="col-md-12">
                        ...
                        <div class="">
                            <div class="">
                                <h4>Report for Week: {{ $start_date }} to {{ $end_date }}</h4>
                            </div>
                            <div class="">
